...
// 파이프라인 입력을 node와 nunjucks precompile에 전달

  } else {

    & "$basedir/node$exe"  "$basedir/../nunjucks/bin/precompile" $args
// 입력 없이 node와 nunjucks precompile 실행
  }
...
// 파이프라인 입력을 기본 node와 nunjucks precompile에 전달

  } else {

    & "node$exe"  "$basedir/../nunjucks/bin/precompile" $args
// 입력 없이 기본 node와 nunjucks precompile 실행
  }
